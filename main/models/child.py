...
class Child(models.Model):
    ...
    expedient = models.OneToOneField(Expedient, on_delete=models.CASCADE, verbose_name='Expediente', default='')
    room = models.ForeignKey(Room, on_delete=models.CASCADE, null=True, verbose_name='Salon')
